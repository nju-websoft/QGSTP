...
import com.bosch.database.MysqlWriter;
...
public class Util {
    ...
    public static final String MONDIAL = "mondial";
    ...
    /**
     * true if we are using boschkg
     */
    public static final boolean BOSCHKG = false;
    public static String DATA_DIR = "F:\\data\\www\\";
     ...
     */
    public static boolean USERDF2VEC = true;
    public static boolean CHECK_TIMEOUT = true;
    ...
    public static void writeJdbcPPS() {
        ...
        pps.setProperty("PASS", "shiyuxuan");
    ...
    public static String getLabelWriterPath(@NotNull String graphName, int id) {
        String filePath = DATA_DIR + graphName;
        File fp = new File(filePath);
        if (!fp.exists()) {
            fp.mkdirs();
        }
        String path = "F:\\data\\www" + graphName + "\\labels" + id + ".txt";
